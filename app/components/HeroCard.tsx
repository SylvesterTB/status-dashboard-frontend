...
export default function LambdaCar({title, description}: HeroCardProps)
{
    return(
        <>
        <div className="w-72 h-64 bg-slate-100 rounded-2xl shadow-lg flex flex-col items-center justify-center transition-transform duration-300 group hover:-translate-y-2 hover:shadow-2xl">
